...
export default function Navbar() {
  ...
  return (
    <>
      {/* --- FIXED NAVBAR HEADER --- */}
      <header className="fixed top-0 left-0 right-0 z-50 bg-base-100/90 backdrop-blur-md border-b border-base-200 shadow-xs transition-all">
          ...
          <div className="navbar-end gap-2">
            {isPending ? (
              ...
              <div className="flex items-center gap-2">
                ...
                <Link href="/signup" className="btn btn-primary btn-sm font-semibold shadow-md shadow-primary/20">
                  Register
                </Link>
              </div>
            )}
