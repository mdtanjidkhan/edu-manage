...
// import { useState, useEffect } from 'react';
// import { CreditCard, CheckCircle2, AlertCircle, Send, User, BookOpen, Hash, Layers } from 'lucide-react';
// import { authClient } from '@/lib/auth-client';
...
//         setMessage({ type: 'success', text: 'Payment submitted successfully!' });
//         setTrxID('');
//         setTimeout(() => setSelectedFee(null), 2500);
//       } else {
//         setMessage({ type: 'error', text: result.message || 'Payment failed!' });
//       }
//     } catch (error) {
...
//             </div>
//             <div className="p-3 bg-[#0f172a] rounded-xl border border-slate-800/80">
//               <span className="text-xs text-slate-400 flex items-center gap-1"><Hash className="w-3.5 h-3.5"/> Roll</span>
...
//               <p className="font-semibold text-pink-400">Merchant Number: 01700000000</p>
//               <p>
//                 Send Money / Merchant Pay <strong>৳{selectedFee.amount}</strong> to the number above and enter your bKash TrxID below.
//               </p>
//             </div>
